...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<PlatformError> handleException(Exception e) {
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new PlatformError(500, e.getMessage()));
    }
